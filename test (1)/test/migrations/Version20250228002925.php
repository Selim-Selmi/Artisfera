 ...
 */
final class Version20250228002925 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE commentaire CHANGE date date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
